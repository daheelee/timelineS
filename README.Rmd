...
[![Travis-CI Build Status](https://travis-ci.org/daheelee/timelineS.svg?branch=master)](https://travis-ci.org/daheelee/timelineS)
[![CRAN Status Badge](http://www.r-pkg.org/badges/version/timelineS)](http://cran.r-project.org/package=timelineS)
[![CRAN Downloads](http://cranlogs.r-pkg.org/badges/timelineS)](https://cran.r-project.org/package=timelineS)
